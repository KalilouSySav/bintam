          ...
          builder: (context, cart, child) {
            if (cart.items.isEmpty) {
              return LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  clampDouble(availableWidth * 0.13, 50, 100);
                  final double textFontSize =
                  clampDouble(availableWidth * 0.04, 14, 24);
            ...
            return LayoutBuilder(
              builder: (context, constraints) {
                ...
                clampDouble(availableWidth * 0.04, 12, 32);
                final double totalFontSize =
                clampDouble(availableWidth * 0.045, 16, 26);
                final double buttonPaddingVertical =
                clampDouble(availableHeight * 0.02, 10, 20);
                final double buttonTextFontSize =
                clampDouble(availableWidth * 0.04, 14, 20);
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    '${cart.totalAmount.toStringAsFixed(2)} CFA',
                                    style: TextStyle(
                                      fontSize: totalFontSize,
                                      fontWeight: FontWeight.bold,
                                      color: Colors.black,
